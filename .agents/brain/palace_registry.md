...
- **Room: `room_dsom_protocol`**
  ...
  *Context:* Core protocol docs — SOD/EOD rituals, RITUAL-OF-TRANSITION, AI-MASTER-PROTOCOL laws, README/SUMMARY evolution, Tri-Phasic Mind model, and Council of High Intelligence proposal.

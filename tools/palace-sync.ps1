...
$ProposalLines.Add("---")
$ProposalLines.Add("okf_version: 0.2")
$ProposalLines.Add("type: spatial_manifest")
$ProposalLines.Add("title: `"🏛️ Palace Update Proposal ($DateStamp)`"")
$ProposalLines.Add("timestamp: `"$DateStamp`"")
$ProposalLines.Add("topics: [`"dsom`", `"palace-sync`", `"spatial-memory`", `"proposal`", `"okf`"]")
$ProposalLines.Add("description: `"Automated Palace room sync proposal generated during EOD ritual.`"")
$ProposalLines.Add("sources: [`".agents/brain/palace_registry.md`"]")
$ProposalLines.Add("generated: `"tools/palace-sync.ps1`"")
$ProposalLines.Add("verified: true")
$ProposalLines.Add("status: `"pending`"")
$ProposalLines.Add("stale_after: `"$DateStamp`"")
$ProposalLines.Add("---")
$ProposalLines.Add("")
...
# --- Write proposal file (BOM-less UTF-8) ---
$Utf8NoBom = [System.Text.UTF8Encoding]::new($false)
[System.IO.File]::WriteAllText($ProposalFile, ($ProposalLines -join "`n"), $Utf8NoBom)

# --- Update sync marker ---
[System.IO.File]::WriteAllText($MarkerFile, $CurrentHead, $Utf8NoBom)

...
The original thesis relied heavily on external Git providers (GitHub/GitLab) for synchronization. Real-world application in the UM Elastic SOC project demanded *Absolute Air-Gapped GitOps*. 

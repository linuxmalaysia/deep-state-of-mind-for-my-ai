# 🕯️ The DSOM Ritual of Transition (v3.0)
...
## 🏛️ 1. Methodological Foundation (CRISP² Alignment)
...
| :--- | :--- | :--- |
| **🌅 Reanimation** | **L1: Phase** | Business/Data Understanding: Bootstrapping the AI's mental state. |
| **🛠️ Active Flow** | **L2: Generic Tasks** | Data Preparation/Modelling: Applying the **CRISP Mandate**. |
| **🔍 Layer Audit** | **L3: Specialised Tasks** | Implementation: Verifying **Clean Architecture** compliance. |
| **🌙 Hibernation** | **L4: Process Instance** | Deployment/Record: Saving the **Mental Anchor** as an audit trail. |

---

## 🌅 Phase 1: Reanimation (Start-of-Day Ritual)
...
## 🛠️ Phase 2: Active Flow (Execution Guardrails)
...
## 🌙 Phase 3: Hibernation (End-of-Session Ritual)

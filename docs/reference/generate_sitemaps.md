...
Dynamic, unified sitemap and search engine optimizer (SEO) asset generator.
...
- **sitemap.xml:** Standard XML sitemap with synchronized `<lastmod>` tags.
...
- **Returns:** String normalized GitBook URL slug.

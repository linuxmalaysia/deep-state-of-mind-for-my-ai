...
This guide explains how to audit, standardize, and auto-correct Markdown files to ensure compliance with the **Open Knowledge Format (OKF v0.1)**.
...
## Step 1: Scan and standardize directory frontmatter

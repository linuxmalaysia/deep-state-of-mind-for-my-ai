...
* **Agnostic & Portable:** Optimized for Enterprise Linux (RHEL, AlmaLinux, Ubuntu). 
...
* **Context Decay** is detected. Request a "State Reset" and re-sync artifacts.

...
class TestSitemapsAndContext7(unittest.TestCase):
    ...
    def test_sitemaps_consistency(self):
        ...
        root_txt = self.repo_root / "sitemap.txt"
        docs_txt = self.repo_root / "docs" / "sitemap.txt"
        root_xml = self.repo_root / "sitemap.xml"
        docs_xml = self.repo_root / "docs" / "sitemap.xml"
    ...
    def test_context7_configuration(self):
        ...
        ctx7_file = self.repo_root / "context7.json"
        ...
        skill_file = self.repo_root / ".agents" / "skills" / "context7-indexer" / "SKILL.md"

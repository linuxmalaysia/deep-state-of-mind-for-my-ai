...
NEW_DIATAXIS_FILES = [
    ...
    ("how-to/install-gitea-podman-quadlet.md", "How-To: Deploy Sovereign Gitea via Rootless Podman & Quadlet"),
    ("how-to/install-gitea-ansible.md", "How-To: Deploy Sovereign Gitea via Automated Ansible Playbook"),
...
DIATAXIS_NAV_ENTRIES = [
    ...
    ("Deploy Gitea via Podman & Quadlet", "how-to/install-gitea-podman-quadlet.md"),
    ("Deploy Gitea via Ansible Playbook", "how-to/install-gitea-ansible.md"),
...
DIATAXIS_SITEMAP_SAMPLE_PATHS = [
    ...
    "how-to/",
    "how-to/install-gitea-podman-quadlet/",
    "how-to/install-gitea-ansible/",
